Feature: Create-Retrieve-Update-Delete
  ...
  Scenario: Create an intervention
    ...
    And the header "Content-Location" should be equal to "/interventions/IRCO000056"
    And the header "Location" should be equal to "/interventions/IRCO000056"
    And the JSON should be equal to:
    """
    {
      "@context": "/contexts/Intervention",
      "@id": "/interventions/IRCO000056",
      "@type": "Intervention",
      "orderDate": "2020-03-27T00:00:00+00:00",
      ...
      "appointmentTime": "2020-03-27T00:00:00+00:00",
  ...
  Scenario: I cannot delete an intervention
    When I add "Accept" header equal to "application/ld+json"
    And I send a "DELETE" request to "/interventions/IRCO000056"
