...
abstract class AbstractPagination
{
     ...
     */
    protected function getEnabled(array $context, string $resourceClass = null, string $operationName = null, bool $partial = false): bool
    {
    ...
    protected function getGraphQlEnabled(?string $resourceClass, ?string $operationName): bool
    {
     ...
     */
    protected function getParameterFromContext(array $context, string $parameterName, $default = null)
    {
