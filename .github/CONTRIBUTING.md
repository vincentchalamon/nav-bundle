# Contributing to Nav bundle

First of all, thank you for contributing, you're awesome!

To have your code integrated in the Nav bundle, there are some rules to follow, but don't panic, it's easy!
...
The Nav bundle follows [Symfony coding standards](https://symfony.com/doc/current/contributing/code/standards.html).
...
* Also don't forget to add a comment when you update a PR with a ping to maintainer (@vincentchalamon)
...
When you open a Pull Request to the Nav bundle, you agree to license your code under the [MIT license](LICENSE)
and to transfer the copyright on the submitted code to Vincent Chalamon.
